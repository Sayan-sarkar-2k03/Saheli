...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        SharedPreferences sharedpreferences = getSharedPreferences(getString(Build.VERSION_CODES.R.string.app_name), Context.MODE_PRIVATE);
...
//                v=(Vibrator)context.getSystemService(Context.VIBRATOR_SERVICE);
                ...
                if (!txt_pnumber1.getText().toString().equals("") && !txt_pnumber2.getText().toString().equals("") && !txt_pnumber3.getText().toString().equals("") && !txt_pnumber4.getText().toString().equals("")) {
                    ...
                    Toast.makeText(MainActivity2.this, "Saved but some fields are blank...", Toast.LENGTH_SHORT).show();

                } else
                    Toast.makeText(MainActivity2.this, "Please enter the numbers first...", Toast.LENGTH_SHORT).show();
    ...
    private void makeCall() {
        ...
        if (phoneNumber.trim().isEmpty()) {
            Toast.makeText(MainActivity2.this, "Please enter first number to make a call..", Toast.LENGTH_SHORT).show();
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (!txt_pnumber1.getText().toString().equals("") || !txt_pnumber2.getText().toString().equals("") || !txt_pnumber3.getText().toString().equals("") || !txt_pnumber4.getText().toString().equals("")) {
                    ...
                    Toast.makeText(MainActivity2.this, "Please give the phone number first...", Toast.LENGTH_SHORT).show();
                }
